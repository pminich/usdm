...
class StudyRole(BaseModel):
    ...
    assigned_persons: Optional[List[StrictStr]] = Field(default=None, alias="assignedPersons")
    code: StrictStr
    masking: Optional[StrictStr] = None
    organizations: Optional[List[StrictStr]] = None
    applies_to: Optional[List[StrictStr]] = Field(default=None, alias="appliesTo")
    instance_type: Optional[StrictStr] = Field(default=None, alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "name", "label", "description", "assignedPersons", "code", "masking", "organizations", "appliesTo", "instanceType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignedPersons": obj.get("assignedPersons"),
            "code": obj.get("code"),

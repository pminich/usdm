...
class ScheduleTimeline(BaseModel):
    ...
    main_timeline: StrictStr = Field(alias="mainTimeline")
    instances: Optional[List[StrictStr]] = None
    entry: StrictStr
    exits: Optional[List[StrictStr]] = None
    timings: Optional[List[StrictStr]] = None
    instance_type: Optional[StrictStr] = Field(default=None, alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "label", "entryCondition", "mainTimeline", "instances", "entry", "exits", "timings", "instanceType"]

...
class StudyChange(BaseModel):
    ...
    rationale: StrictStr
    summary: StrictStr
    changed_sections: List[StrictStr] = Field(alias="changedSections")
    instance_type: Optional[StrictStr] = Field(default=None, alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "label", "rationale", "summary", "changedSections", "instanceType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changedSections": obj.get("changedSections"),

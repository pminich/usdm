...
class AdministrationDuration(BaseModel):
    ...
    duration_will_vary: StrictStr = Field(alias="durationWillVary")
    ...
    __properties: ClassVar[List[str]] = ["id", "description", "durationWillVary", "reasonDurationWillVary", "quantity", "instanceType"]

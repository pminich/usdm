...
class BiospecimenRetention(BaseModel):
    ...
    label: StrictStr
    is_retained: StrictStr = Field(alias="isRetained")
    includes_dna: StrictStr = Field(alias="includesDNA")
    instance_type: Optional[StrictStr] = Field(default=None, alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "label", "isRetained", "includesDNA", "instanceType"]

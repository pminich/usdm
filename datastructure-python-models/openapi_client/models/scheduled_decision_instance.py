...
class ScheduledDecisionInstance(BaseModel):
    ...
    condition_assignments: List[StrictStr] = Field(alias="conditionAssignments")
    instance_type: Optional[StrictStr] = Field(default=None, alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "label", "defaultCondition", "epoch", "conditionAssignments", "instanceType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "epoch": obj.get("epoch"),
            "conditionAssignments": obj.get("conditionAssignments"),

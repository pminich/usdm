...
class SyntaxTemplateDictionary(BaseModel):
    ...
    label: StrictStr
    parameter_maps: List[StrictStr] = Field(alias="parameterMaps")
    instance_type: Optional[StrictStr] = Field(default=None, alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "label", "parameterMaps", "instanceType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "label": obj.get("label"),
            "parameterMaps": obj.get("parameterMaps"),

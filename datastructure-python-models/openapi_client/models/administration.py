...
class Administration(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "label", "administrableProduct", "route", "dose", "frequency", "notes", "duration", "medicalDevice", "instanceType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "label": obj.get("label"),
            "administrableProduct": obj.get("administrableProduct"),
            "route": obj.get("route"),
            "dose": obj.get("dose"),
            "frequency": obj.get("frequency"),
            "notes": obj.get("notes"),
            "duration": obj.get("duration"),
            "medicalDevice": obj.get("medicalDevice"),

...
class AliasCode(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    standard_code: StrictStr = Field(alias="standardCode")
    standard_code_aliases: Optional[List[StrictStr]] = Field(default=None, alias="standardCodeAliases")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "standardCode": obj.get("standardCode"),
            "standardCodeAliases": obj.get("standardCodeAliases"),

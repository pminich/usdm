...
class Procedure(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "label", "procedureType", "code", "notes", "studyIntervention", "instanceType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "notes": obj.get("notes"),
            "studyIntervention": obj.get("studyIntervention"),

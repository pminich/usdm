...
class ScheduledActivityInstance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "label", "defaultCondition", "epoch", "activities", "encounter", "timeline", "timelineExit", "instanceType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "label": obj.get("label"),
            "defaultCondition": obj.get("defaultCondition"),
            "epoch": obj.get("epoch"),
            "activities": obj.get("activities"),
            "encounter": obj.get("encounter"),
            "timeline": obj.get("timeline"),
            "timelineExit": obj.get("timelineExit"),

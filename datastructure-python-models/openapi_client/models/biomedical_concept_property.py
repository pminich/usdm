...
class BiomedicalConceptProperty(BaseModel):
    ...
    name: StrictStr
    label: StrictStr
    is_required: StrictStr = Field(alias="isRequired")
    is_enabled: StrictStr = Field(alias="isEnabled")
    datatype: StrictStr
    code: StrictStr
    response_codes: Optional[List[StrictStr]] = Field(default=None, alias="responseCodes")
    notes: Optional[List[StrictStr]] = None
    instance_type: Optional[StrictStr] = Field(default=None, alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "name", "label", "isRequired", "isEnabled", "datatype", "code", "responseCodes", "notes", "instanceType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "responseCodes": obj.get("responseCodes"),
            "notes": obj.get("notes"),

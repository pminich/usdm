...
class ConditionAssignment(BaseModel):
    ...
    id: StrictStr
    condition: StrictStr
    condition_target: StrictStr = Field(alias="conditionTarget")
    instance_type: Optional[StrictStr] = Field(default=None, alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "condition", "conditionTarget", "instanceType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conditionTarget": obj.get("conditionTarget"),

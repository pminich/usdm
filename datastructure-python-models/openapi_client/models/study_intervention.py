...
class StudyIntervention(BaseModel):
    ...
    name: StrictStr
    label: StrictStr
    administrations: Optional[List[StrictStr]] = None
    type: StrictStr
    role: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "description", "name", "label", "administrations", "type", "role", "codes", "notes", "minimumResponseDuration", "instanceType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "codes": obj.get("codes"),
            "notes": obj.get("notes"),
            "minimumResponseDuration": obj.get("minimumResponseDuration"),

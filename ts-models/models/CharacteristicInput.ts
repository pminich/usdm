...
export class CharacteristicInput {
    ...
    'instanceType': CharacteristicInputInstanceTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "CharacteristicInputInstanceTypeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return CharacteristicInput.attributeTypeMap;
    }
...
export enum CharacteristicInputInstanceTypeEnum {

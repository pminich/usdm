...
export class EndpointOutput {
    ...
    'instanceType': EndpointOutputInstanceTypeEnum;
    'purpose': string;
    'level': Code;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "EndpointOutputInstanceTypeEnum",
            "format": ""
        },
        {
            "name": "purpose",
    ...
    static getAttributeTypeMap() {
        return EndpointOutput.attributeTypeMap;
    }
...
export enum EndpointOutputInstanceTypeEnum {
    Endpoint = 'Endpoint'
}

...
export class StudyElementOutput {
    'id': string;
    'name': string;
    'label'?: string | null;
    ...
    'studyInterventionIds'?: Array<string>;
    'notes'?: Array<CommentAnnotation>;
    'instanceType': StudyElementOutputInstanceTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "StudyElementOutputInstanceTypeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return StudyElementOutput.attributeTypeMap;
    }
...
export enum StudyElementOutputInstanceTypeEnum {

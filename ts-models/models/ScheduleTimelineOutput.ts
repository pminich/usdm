...
export class ScheduleTimelineOutput {
    'id': string;
    'name': string;
    'label'?: string | null;
    ...
    'instanceType': ScheduleTimelineOutputInstanceTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "ScheduleTimelineOutputInstanceTypeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ScheduleTimelineOutput.attributeTypeMap;
    }
...
export enum ScheduleTimelineOutputInstanceTypeEnum {

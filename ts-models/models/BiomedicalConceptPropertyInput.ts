...
export class BiomedicalConceptPropertyInput {
    'id': string;
    'name': string;
    'label'?: string | null;
    'isRequired': boolean;
    ...
    'instanceType': BiomedicalConceptPropertyInputInstanceTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "BiomedicalConceptPropertyInputInstanceTypeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return BiomedicalConceptPropertyInput.attributeTypeMap;
    }
...
export enum BiomedicalConceptPropertyInputInstanceTypeEnum {

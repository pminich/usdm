...
class StudyAmendmentReason(BaseModel):
    """
    NCI C-Code: C207457 Definition: The rationale for the change(s) to, or formal clarification of, a protocol. Preferred Term: Study Amendment Reason  # noqa: E501
    """
    id: StrictStr = Field(...)
    other_reason: StrictStr = Field(default=..., alias="otherReason")
    code: StrictStr = Field(...)
    instance_type: Optional[StrictStr] = Field(default=None, alias="instanceType")
    __properties = ["id", "otherReason", "code", "instanceType"]

...
class AnalysisPopulation(BaseModel):
    ...
    subset_of: Optional[conlist(StrictStr)] = Field(default=None, alias="subsetOf")
    notes: Optional[conlist(StrictStr)] = None
    instance_type: Optional[StrictStr] = Field(default=None, alias="instanceType")
    __properties = ["id", "text", "name", "description", "label", "subsetOf", "notes", "instanceType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnalysisPopulation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnalysisPopulation:
        """Create an instance of AnalysisPopulation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnalysisPopulation.parse_obj(obj)

        _obj = AnalysisPopulation.parse_obj({
            "id": obj.get("id"),
            "text": obj.get("text"),
            "name": obj.get("name"),
            "description": obj.get("description"),
            "label": obj.get("label"),
            "subset_of": obj.get("subsetOf"),
            "notes": obj.get("notes"),

...
class InterventionalStudyDesign(BaseModel):
    """
    NCI C-Code: CNEW Definition: The strategy that specifies the structure of an interventional trial in terms of the planned activities (including timing) and statistical analysis approach intended to meet the objectives of the study. Preferred Term: Interventional Study Design  # noqa: E501
    """
    id: StrictStr = Field(...)
    ...
    intent_types: Optional[conlist(StrictStr)] = Field(default=None, alias="intentTypes")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InterventionalStudyDesign:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InterventionalStudyDesign:
        """Create an instance of InterventionalStudyDesign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InterventionalStudyDesign.parse_obj(obj)

        _obj = InterventionalStudyDesign.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "intent_types": obj.get("intentTypes"),
            "model": obj.get("model"),
            "blinding_schema": obj.get("blindingSchema"),

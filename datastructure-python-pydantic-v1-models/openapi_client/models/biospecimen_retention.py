...
class BiospecimenRetention(BaseModel):
    """
    NCI C-Code: CNEW Definition: The continued possession, cataloging, and storage of collected biological specimens beyond their initial use. Preferred Term: Biospecimen Retention  # noqa: E501
    """
    id: StrictStr = Field(...)
    name: StrictStr = Field(...)
    description: StrictStr = Field(...)
    label: StrictStr = Field(...)
    is_retained: StrictStr = Field(default=..., alias="isRetained")
    includes_dna: StrictStr = Field(default=..., alias="includesDNA")
    instance_type: Optional[StrictStr] = Field(default=None, alias="instanceType")
    __properties = ["id", "name", "description", "label", "isRetained", "includesDNA", "instanceType"]

...
class BiomedicalConceptSurrogateInput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BiomedicalConceptSurrogateInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BiomedicalConceptSurrogateInput:
        """Create an instance of BiomedicalConceptSurrogateInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BiomedicalConceptSurrogateInput.parse_obj(obj)

        _obj = BiomedicalConceptSurrogateInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

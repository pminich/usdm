...
class ProcedureInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProcedureInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProcedureInput:
        """Create an instance of ProcedureInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProcedureInput.parse_obj(obj)

        _obj = ProcedureInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

...
class EligibilityCriterionOutput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EligibilityCriterionOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EligibilityCriterionOutput:
        """Create an instance of EligibilityCriterionOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EligibilityCriterionOutput.parse_obj(obj)

        _obj = EligibilityCriterionOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

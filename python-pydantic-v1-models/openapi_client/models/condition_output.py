...
class ConditionOutput(BaseModel):
    ...
    context_ids: Optional[conlist(StrictStr)] = Field(default=None, alias="contextIds")
    applies_to_ids: Optional[conlist(StrictStr)] = Field(default=None, alias="appliesToIds")
    __properties = ["id", "name", "label", "description", "text", "dictionaryId", "notes", "instanceType", "contextIds", "appliesToIds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConditionOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConditionOutput:
        """Create an instance of ConditionOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConditionOutput.parse_obj(obj)

        _obj = ConditionOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            ...
            "context_ids": obj.get("contextIds"),

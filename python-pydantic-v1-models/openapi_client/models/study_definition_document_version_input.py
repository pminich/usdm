...
class StudyDefinitionDocumentVersionInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StudyDefinitionDocumentVersionInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StudyDefinitionDocumentVersionInput:
        """Create an instance of StudyDefinitionDocumentVersionInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StudyDefinitionDocumentVersionInput.parse_obj(obj)

        _obj = StudyDefinitionDocumentVersionInput.parse_obj({
            "id": obj.get("id"),

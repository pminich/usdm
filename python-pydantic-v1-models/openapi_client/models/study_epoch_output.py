...
class StudyEpochOutput(BaseModel):
    """
    StudyEpochOutput
    """
    ...
    __properties = ["id", "name", "label", "description", "type", "previousId", "nextId", "notes", "instanceType"]

    @validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('StudyEpoch',):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StudyEpochOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StudyEpochOutput:
        """Create an instance of StudyEpochOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StudyEpochOutput.parse_obj(obj)

        _obj = StudyEpochOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

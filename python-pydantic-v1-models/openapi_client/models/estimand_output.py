...
class EstimandOutput(BaseModel):
    ...
    intercurrent_events: conlist(IntercurrentEventOutput) = Field(default=..., alias="intercurrentEvents")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimandOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimandOutput:
        """Create an instance of EstimandOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimandOutput.parse_obj(obj)

        _obj = EstimandOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            ...
            "intercurrent_events": [IntercurrentEventOutput.from_dict(_item) for _item in obj.get("intercurrentEvents")] if obj.get("intercurrentEvents") is not None else None,

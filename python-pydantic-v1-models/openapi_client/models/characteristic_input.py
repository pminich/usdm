...
class CharacteristicInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CharacteristicInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CharacteristicInput:
        """Create an instance of CharacteristicInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CharacteristicInput.parse_obj(obj)

        _obj = CharacteristicInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

...
class StudyEpochInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StudyEpochInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StudyEpochInput:
        """Create an instance of StudyEpochInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StudyEpochInput.parse_obj(obj)

        _obj = StudyEpochInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

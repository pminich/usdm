...
class GeographicScopeInput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeographicScopeInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeographicScopeInput:
        """Create an instance of GeographicScopeInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeographicScopeInput.parse_obj(obj)

        _obj = GeographicScopeInput.parse_obj({
            "id": obj.get("id"),

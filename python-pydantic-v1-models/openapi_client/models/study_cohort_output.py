...
class StudyCohortOutput(BaseModel):
    ...
    characteristics: Optional[conlist(CharacteristicOutput)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StudyCohortOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StudyCohortOutput:
        """Create an instance of StudyCohortOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StudyCohortOutput.parse_obj(obj)

        _obj = StudyCohortOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            ...
            "characteristics": [CharacteristicOutput.from_dict(_item) for _item in obj.get("characteristics")] if obj.get("characteristics") is not None else None
        })
        return _obj

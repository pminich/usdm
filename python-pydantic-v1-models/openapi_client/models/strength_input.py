...
class StrengthInput(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> StrengthInput:
        ...
        _obj = StrengthInput.parse_obj({
            ...
            "denominator": QuantityInput.from_dict(obj.get("denominator")) if obj.get("denominator") is not None else None,
            "numerator": Numerator.from_dict(obj.get("numerator")) if obj.get("numerator") is not None else None,

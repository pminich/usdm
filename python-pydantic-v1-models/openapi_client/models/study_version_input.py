...
class StudyVersionInput(BaseModel):
    ...
    date_values: Optional[conlist(GovernanceDateInput)] = Field(default=None, alias="dateValues")
    amendments: Optional[conlist(StudyAmendmentInput)] = None
    ...
    study_designs: Optional[conlist(StudyVersionInputStudyDesignsInner)] = Field(default=None, alias="studyDesigns")
    titles: conlist(StudyTitle) = Field(...)
    criteria: conlist(EligibilityCriterionInput) = Field(...)
    narrative_content_items: Optional[conlist(NarrativeContentItem)] = Field(default=None, alias="narrativeContentItems")
    abbreviations: Optional[conlist(AbbreviationInput)] = None
    roles: Optional[conlist(StudyRole)] = None
    organizations: Optional[conlist(OrganizationInput)] = None
    administrable_products: Optional[conlist(AdministrableProductInput)] = Field(default=None, alias="administrableProducts")
    medical_devices: Optional[conlist(MedicalDeviceInput)] = Field(default=None, alias="medicalDevices")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StudyVersionInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StudyVersionInput:
        """Create an instance of StudyVersionInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StudyVersionInput.parse_obj(obj)

        _obj = StudyVersionInput.parse_obj({
            "id": obj.get("id"),
            "version_identifier": obj.get("versionIdentifier"),
            "rationale": obj.get("rationale"),
            "document_version_ids": obj.get("documentVersionIds"),
            "date_values": [GovernanceDateInput.from_dict(_item) for _item in obj.get("dateValues")] if obj.get("dateValues") is not None else None,
            "amendments": [StudyAmendmentInput.from_dict(_item) for _item in obj.get("amendments")] if obj.get("amendments") is not None else None,
            ...
            "study_designs": [StudyVersionInputStudyDesignsInner.from_dict(_item) for _item in obj.get("studyDesigns")] if obj.get("studyDesigns") is not None else None,
            "titles": [StudyTitle.from_dict(_item) for _item in obj.get("titles")] if obj.get("titles") is not None else None,
            "criteria": [EligibilityCriterionInput.from_dict(_item) for _item in obj.get("criteria")] if obj.get("criteria") is not None else None,
            ...
            "abbreviations": [AbbreviationInput.from_dict(_item) for _item in obj.get("abbreviations")] if obj.get("abbreviations") is not None else None,
            "roles": [StudyRole.from_dict(_item) for _item in obj.get("roles")] if obj.get("roles") is not None else None,
            "organizations": [OrganizationInput.from_dict(_item) for _item in obj.get("organizations")] if obj.get("organizations") is not None else None,
            "administrable_products": [AdministrableProductInput.from_dict(_item) for _item in obj.get("administrableProducts")] if obj.get("administrableProducts") is not None else None,
            "medical_devices": [MedicalDeviceInput.from_dict(_item) for _item in obj.get("medicalDevices")] if obj.get("medicalDevices") is not None else None,

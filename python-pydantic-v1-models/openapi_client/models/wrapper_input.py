...
class WrapperInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WrapperInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WrapperInput:
        """Create an instance of WrapperInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WrapperInput.parse_obj(obj)

        _obj = WrapperInput.parse_obj({
            "study": StudyInput.from_dict(obj.get("study")) if obj.get("study") is not None else None,

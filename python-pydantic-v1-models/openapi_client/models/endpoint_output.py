...
class EndpointOutput(BaseModel):
    ...
    level: Code = Field(...)
    __properties = ["id", "name", "label", "description", "text", "dictionaryId", "notes", "instanceType", "purpose", "level"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EndpointOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EndpointOutput:
        """Create an instance of EndpointOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EndpointOutput.parse_obj(obj)

        _obj = EndpointOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

...
class IndicationInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IndicationInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IndicationInput:
        """Create an instance of IndicationInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IndicationInput.parse_obj(obj)

        _obj = IndicationInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

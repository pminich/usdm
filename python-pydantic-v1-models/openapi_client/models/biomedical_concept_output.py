...
class BiomedicalConceptOutput(BaseModel):
    ...
    properties: Optional[conlist(BiomedicalConceptPropertyOutput)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BiomedicalConceptOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BiomedicalConceptOutput:
        """Create an instance of BiomedicalConceptOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BiomedicalConceptOutput.parse_obj(obj)

        _obj = BiomedicalConceptOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            "synonyms": obj.get("synonyms"),
            "reference": obj.get("reference"),
            "properties": [BiomedicalConceptPropertyOutput.from_dict(_item) for _item in obj.get("properties")] if obj.get("properties") is not None else None,

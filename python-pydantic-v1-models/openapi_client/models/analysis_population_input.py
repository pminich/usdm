...
class AnalysisPopulationInput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnalysisPopulationInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnalysisPopulationInput:
        """Create an instance of AnalysisPopulationInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnalysisPopulationInput.parse_obj(obj)

        _obj = AnalysisPopulationInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

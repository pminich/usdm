...
class ActivityInput(BaseModel):
    ...
    defined_procedures: Optional[conlist(ProcedureInput)] = Field(default=None, alias="definedProcedures")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityInput:
        """Create an instance of ActivityInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityInput.parse_obj(obj)

        _obj = ActivityInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            ...
            "defined_procedures": [ProcedureInput.from_dict(_item) for _item in obj.get("definedProcedures")] if obj.get("definedProcedures") is not None else None,

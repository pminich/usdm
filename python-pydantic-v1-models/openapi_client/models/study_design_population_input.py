...
class StudyDesignPopulationInput(BaseModel):
    ...
    cohorts: Optional[conlist(StudyCohortInput)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StudyDesignPopulationInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StudyDesignPopulationInput:
        """Create an instance of StudyDesignPopulationInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StudyDesignPopulationInput.parse_obj(obj)

        _obj = StudyDesignPopulationInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            ...
            "cohorts": [StudyCohortInput.from_dict(_item) for _item in obj.get("cohorts")] if obj.get("cohorts") is not None else None
        })
        return _obj

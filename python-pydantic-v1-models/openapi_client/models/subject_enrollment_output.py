...
class SubjectEnrollmentOutput(BaseModel):
    ...
    quantity: Optional[QuantityOutput] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubjectEnrollmentOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubjectEnrollmentOutput:
        """Create an instance of SubjectEnrollmentOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubjectEnrollmentOutput.parse_obj(obj)

        _obj = SubjectEnrollmentOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            "description": obj.get("description"),
            "quantity": QuantityOutput.from_dict(obj.get("quantity")) if obj.get("quantity") is not None else None,
            "applies_to": GeographicScopeOutput.from_dict(obj.get("appliesTo")) if obj.get("appliesTo") is not None else None,

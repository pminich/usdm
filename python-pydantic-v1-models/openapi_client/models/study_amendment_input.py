...
class StudyAmendmentInput(BaseModel):
    """
    StudyAmendmentInput
    """
    ...
    impacts: Optional[conlist(StudyAmendmentImpactInput)] = None
    geographic_scopes: conlist(GeographicScopeInput) = Field(default=..., alias="geographicScopes")
    enrollments: Optional[conlist(SubjectEnrollmentInput)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StudyAmendmentInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StudyAmendmentInput:
        """Create an instance of StudyAmendmentInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StudyAmendmentInput.parse_obj(obj)

        _obj = StudyAmendmentInput.parse_obj({
            "id": obj.get("id"),
            ...
            "impacts": [StudyAmendmentImpactInput.from_dict(_item) for _item in obj.get("impacts")] if obj.get("impacts") is not None else None,
            "geographic_scopes": [GeographicScopeInput.from_dict(_item) for _item in obj.get("geographicScopes")] if obj.get("geographicScopes") is not None else None,
            "enrollments": [SubjectEnrollmentInput.from_dict(_item) for _item in obj.get("enrollments")] if obj.get("enrollments") is not None else None,

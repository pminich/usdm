...
class ConditionAssignment(BaseModel):
    ...
    condition_target_id: StrictStr = Field(default=..., alias="conditionTargetId")
    instance_type: StrictStr = Field(default=..., alias="instanceType")
    __properties = ["id", "condition", "conditionTargetId", "instanceType"]

    @validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('ConditionAssignment',):
    ...
    def from_dict(cls, obj: dict) -> ConditionAssignment:
        ...
        _obj = ConditionAssignment.parse_obj({
            ...
            "condition_target_id": obj.get("conditionTargetId"),

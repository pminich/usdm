...
class AnalysisPopulationOutput(BaseModel):
    """
    ...
    subset_of_ids: Optional[conlist(StrictStr)] = Field(default=None, alias="subsetOfIds")
    notes: Optional[conlist(CommentAnnotation)] = None
    instance_type: StrictStr = Field(default=..., alias="instanceType")
    __properties = ["id", "name", "label", "description", "text", "subsetOfIds", "notes", "instanceType"]

    @validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('AnalysisPopulation',):
            raise ValueError("must be one of enum values ('AnalysisPopulation')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnalysisPopulationOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnalysisPopulationOutput:
        """Create an instance of AnalysisPopulationOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnalysisPopulationOutput.parse_obj(obj)

        _obj = AnalysisPopulationOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            "description": obj.get("description"),
            "text": obj.get("text"),
            "subset_of_ids": obj.get("subsetOfIds"),

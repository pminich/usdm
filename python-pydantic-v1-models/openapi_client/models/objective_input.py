...
class ObjectiveInput(BaseModel):
    ...
    level: Code = Field(...)
    endpoints: Optional[conlist(EndpointInput)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectiveInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObjectiveInput:
        """Create an instance of ObjectiveInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectiveInput.parse_obj(obj)

        _obj = ObjectiveInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            ...
            "endpoints": [EndpointInput.from_dict(_item) for _item in obj.get("endpoints")] if obj.get("endpoints") is not None else None
        })
        return _obj

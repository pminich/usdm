...
class GovernanceDateInput(BaseModel):
    """
    GovernanceDateInput
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GovernanceDateInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GovernanceDateInput:
        """Create an instance of GovernanceDateInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GovernanceDateInput.parse_obj(obj)

        _obj = GovernanceDateInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

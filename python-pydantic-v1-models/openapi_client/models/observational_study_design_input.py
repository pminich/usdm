...
class ObservationalStudyDesignInput(BaseModel):
    """
    ...
    model: Code = Field(...)
    time_perspective: Code = Field(default=..., alias="timePerspective")
    ...
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('ObservationalStudyDesign',):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObservationalStudyDesignInput:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.sampling_method is None and "sampling_method" in self.__fields_set__:
            _dict['samplingMethod'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> ObservationalStudyDesignInput:
        """Create an instance of ObservationalStudyDesignInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObservationalStudyDesignInput.parse_obj(obj)

        _obj = ObservationalStudyDesignInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            ...
            "time_perspective": Code.from_dict(obj.get("timePerspective")) if obj.get("timePerspective") is not None else None,
            "sampling_method": Code.from_dict(obj.get("samplingMethod")) if obj.get("samplingMethod") is not None else None
        })
        return _obj

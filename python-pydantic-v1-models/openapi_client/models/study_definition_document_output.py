...
class StudyDefinitionDocumentOutput(BaseModel):
    ...
    versions: Optional[conlist(StudyDefinitionDocumentVersionOutput)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StudyDefinitionDocumentOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StudyDefinitionDocumentOutput:
        """Create an instance of StudyDefinitionDocumentOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StudyDefinitionDocumentOutput.parse_obj(obj)

        _obj = StudyDefinitionDocumentOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            ...
            "versions": [StudyDefinitionDocumentVersionOutput.from_dict(_item) for _item in obj.get("versions")] if obj.get("versions") is not None else None,

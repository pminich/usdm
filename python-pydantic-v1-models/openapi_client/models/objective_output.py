...
class ObjectiveOutput(BaseModel):
    ...
    level: Code = Field(...)
    endpoints: Optional[conlist(EndpointOutput)] = None
    __properties = ["id", "name", "label", "description", "text", "dictionaryId", "notes", "instanceType", "level", "endpoints"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectiveOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObjectiveOutput:
        """Create an instance of ObjectiveOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectiveOutput.parse_obj(obj)

        _obj = ObjectiveOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            ...
            "level": Code.from_dict(obj.get("level")) if obj.get("level") is not None else None,
            "endpoints": [EndpointOutput.from_dict(_item) for _item in obj.get("endpoints")] if obj.get("endpoints") is not None else None
        })
        return _obj

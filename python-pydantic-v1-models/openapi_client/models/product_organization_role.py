...
class ProductOrganizationRole(BaseModel):
    ...
    __properties = ["id", "name", "label", "description", "code", "appliesToIds", "organizationId", "instanceType"]

    @validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('ProductOrganizationRole',):
            raise ValueError("must be one of enum values ('ProductOrganizationRole')")
        return value

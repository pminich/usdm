...
class BiomedicalConceptCategoryOutput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BiomedicalConceptCategoryOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BiomedicalConceptCategoryOutput:
        """Create an instance of BiomedicalConceptCategoryOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BiomedicalConceptCategoryOutput.parse_obj(obj)

        _obj = BiomedicalConceptCategoryOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

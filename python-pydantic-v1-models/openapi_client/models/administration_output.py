...
class AdministrationOutput(BaseModel):
    ...
    duration: AdministrationDurationOutput = Field(...)
    dose: Optional[QuantityOutput] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdministrationOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdministrationOutput:
        """Create an instance of AdministrationOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdministrationOutput.parse_obj(obj)

        _obj = AdministrationOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            "description": obj.get("description"),
            "duration": AdministrationDurationOutput.from_dict(obj.get("duration")) if obj.get("duration") is not None else None,
            "dose": QuantityOutput.from_dict(obj.get("dose")) if obj.get("dose") is not None else None,

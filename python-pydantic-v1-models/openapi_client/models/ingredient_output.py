...
class IngredientOutput(BaseModel):
    ...
    role: Code = Field(...)
    substance: SubstanceOutput = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IngredientOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IngredientOutput:
        """Create an instance of IngredientOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IngredientOutput.parse_obj(obj)

        _obj = IngredientOutput.parse_obj({
            "id": obj.get("id"),
            "role": Code.from_dict(obj.get("role")) if obj.get("role") is not None else None,
            "substance": SubstanceOutput.from_dict(obj.get("substance")) if obj.get("substance") is not None else None,

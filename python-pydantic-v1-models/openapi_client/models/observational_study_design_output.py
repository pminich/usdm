...
class ObservationalStudyDesignOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObservationalStudyDesignOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObservationalStudyDesignOutput:
        """Create an instance of ObservationalStudyDesignOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObservationalStudyDesignOutput.parse_obj(obj)

        _obj = ObservationalStudyDesignOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

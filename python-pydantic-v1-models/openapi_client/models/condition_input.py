...
class ConditionInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConditionInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConditionInput:
        """Create an instance of ConditionInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConditionInput.parse_obj(obj)

        _obj = ConditionInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

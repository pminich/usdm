...
class StudyAmendmentImpactInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StudyAmendmentImpactInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StudyAmendmentImpactInput:
        """Create an instance of StudyAmendmentImpactInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StudyAmendmentImpactInput.parse_obj(obj)

        _obj = StudyAmendmentImpactInput.parse_obj({
            "id": obj.get("id"),

...
class BiomedicalConceptSurrogateOutput(BaseModel):
    """
    ...
    __properties = ["id", "name", "label", "description", "reference", "notes", "instanceType"]

    @validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('BiomedicalConceptSurrogate',):
            raise ValueError("must be one of enum values ('BiomedicalConceptSurrogate')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BiomedicalConceptSurrogateOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BiomedicalConceptSurrogateOutput:
        """Create an instance of BiomedicalConceptSurrogateOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BiomedicalConceptSurrogateOutput.parse_obj(obj)

        _obj = BiomedicalConceptSurrogateOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

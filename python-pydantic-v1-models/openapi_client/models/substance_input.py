...
class SubstanceInput(BaseModel):
    ...
    strengths: conlist(StrengthInput) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubstanceInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubstanceInput:
        """Create an instance of SubstanceInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubstanceInput.parse_obj(obj)

        _obj = SubstanceInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),
            "description": obj.get("description"),
            "codes": [Code.from_dict(_item) for _item in obj.get("codes")] if obj.get("codes") is not None else None,
            "strengths": [StrengthInput.from_dict(_item) for _item in obj.get("strengths")] if obj.get("strengths") is not None else None,
            "reference_substance": SubstanceInput.from_dict(obj.get("referenceSubstance")) if obj.get("referenceSubstance") is not None else None,
            "instance_type": obj.get("instanceType")
        })
        return _obj

SubstanceInput.update_forward_refs()

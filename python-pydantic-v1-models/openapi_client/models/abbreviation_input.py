...
class AbbreviationInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AbbreviationInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AbbreviationInput:
        """Create an instance of AbbreviationInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AbbreviationInput.parse_obj(obj)

        _obj = AbbreviationInput.parse_obj({
            "id": obj.get("id"),

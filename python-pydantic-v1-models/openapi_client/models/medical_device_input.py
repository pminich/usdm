...
class MedicalDeviceInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalDeviceInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalDeviceInput:
        """Create an instance of MedicalDeviceInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalDeviceInput.parse_obj(obj)

        _obj = MedicalDeviceInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

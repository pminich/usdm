...
class IntercurrentEventOutput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IntercurrentEventOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IntercurrentEventOutput:
        """Create an instance of IntercurrentEventOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IntercurrentEventOutput.parse_obj(obj)

        _obj = IntercurrentEventOutput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "label": obj.get("label"),

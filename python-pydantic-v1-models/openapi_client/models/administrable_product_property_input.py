...
class AdministrableProductPropertyInput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdministrableProductPropertyInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdministrableProductPropertyInput:
        """Create an instance of AdministrableProductPropertyInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdministrableProductPropertyInput.parse_obj(obj)

        _obj = AdministrableProductPropertyInput.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "text": obj.get("text"),

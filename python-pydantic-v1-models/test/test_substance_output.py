...
from openapi_client.models.substance_output import SubstanceOutput  # noqa: E501

class TestSubstanceOutput(unittest.TestCase):
    """SubstanceOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubstanceOutput:
        """Test SubstanceOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubstanceOutput`
        """
        model = SubstanceOutput()  # noqa: E501
        if include_optional:

...
from openapi_client.models.wrapper_input import WrapperInput  # noqa: E501

class TestWrapperInput(unittest.TestCase):
    """WrapperInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WrapperInput:
        """Test WrapperInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WrapperInput`
        """
        model = WrapperInput()  # noqa: E501
        if include_optional:
            return WrapperInput(

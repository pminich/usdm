...
from openapi_client.models.study_intervention_output import StudyInterventionOutput  # noqa: E501

class TestStudyInterventionOutput(unittest.TestCase):
    """StudyInterventionOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudyInterventionOutput:
        """Test StudyInterventionOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyInterventionOutput`
        """
        model = StudyInterventionOutput()  # noqa: E501
        if include_optional:
            return StudyInterventionOutput(
                id = '0',
                name = '0',
                label = '',
                description = '',
    ...
    def testStudyInterventionOutput(self):
        """Test StudyInterventionOutput"""

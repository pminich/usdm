...
from openapi_client.models.encounter_output import EncounterOutput  # noqa: E501

class TestEncounterOutput(unittest.TestCase):
    """EncounterOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncounterOutput:
        """Test EncounterOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncounterOutput`
        """
        model = EncounterOutput()  # noqa: E501
        if include_optional:

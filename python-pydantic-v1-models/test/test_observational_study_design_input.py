...
from openapi_client.models.observational_study_design_input import ObservationalStudyDesignInput  # noqa: E501

class TestObservationalStudyDesignInput(unittest.TestCase):
    """ObservationalStudyDesignInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObservationalStudyDesignInput:
        """Test ObservationalStudyDesignInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObservationalStudyDesignInput`
        """
        model = ObservationalStudyDesignInput()  # noqa: E501
        if include_optional:
            return ObservationalStudyDesignInput(
                id = '0',
                name = '0',
                label = '',
                description = '',
    ...
    def testObservationalStudyDesignInput(self):
        """Test ObservationalStudyDesignInput"""

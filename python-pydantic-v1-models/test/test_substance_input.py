...
from openapi_client.models.substance_input import SubstanceInput  # noqa: E501

class TestSubstanceInput(unittest.TestCase):
    """SubstanceInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubstanceInput:
        """Test SubstanceInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubstanceInput`
        """
        model = SubstanceInput()  # noqa: E501
        if include_optional:
            return SubstanceInput(
                id = '0',
                name = '0',
                label = '',
                description = '',

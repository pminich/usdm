...
from openapi_client.models.biomedical_concept_output import BiomedicalConceptOutput  # noqa: E501

class TestBiomedicalConceptOutput(unittest.TestCase):
    """BiomedicalConceptOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BiomedicalConceptOutput:
        """Test BiomedicalConceptOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BiomedicalConceptOutput`
        """
        model = BiomedicalConceptOutput()  # noqa: E501
        if include_optional:
            return BiomedicalConceptOutput(
                id = '0',
                name = '0',
                label = '',
                synonyms = [
    ...
    def testBiomedicalConceptOutput(self):
        """Test BiomedicalConceptOutput"""

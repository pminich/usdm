...
from openapi_client.models.study_output import StudyOutput  # noqa: E501

class TestStudyOutput(unittest.TestCase):
    """StudyOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudyOutput:
        """Test StudyOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyOutput`
        """
        model = StudyOutput()  # noqa: E501
        if include_optional:
            return StudyOutput(
                id = '',
                name = '0',

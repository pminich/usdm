...
from openapi_client.models.wrapper_output import WrapperOutput  # noqa: E501

class TestWrapperOutput(unittest.TestCase):
    """WrapperOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WrapperOutput:
        """Test WrapperOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WrapperOutput`
        """
        model = WrapperOutput()  # noqa: E501
        if include_optional:
            return WrapperOutput(
                study = openapi_client.models.study.Study(
                    id = '', 
                    name = '0', 
                    description = '', 
                    label = '', 

...
class SearchStudyDesignV3StudyDesignsGet200ResponseInner(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[InterventionalStudyDesignOutput, ObservationalStudyDesignOutput]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "InterventionalStudyDesignOutput", "ObservationalStudyDesignOutput" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = SearchStudyDesignV3StudyDesignsGet200ResponseInner.model_construct()
        error_messages = []
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], InterventionalStudyDesignOutput, ObservationalStudyDesignOutput]]:

...
class Numerator(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[QuantityInput, RangeInput]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "QuantityInput", "RangeInput" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = Numerator.model_construct()
        error_messages = []
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], QuantityInput, RangeInput]]:

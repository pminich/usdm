...
class StudyCohortInput(BaseModel):
    ...
    criterion_ids: Optional[List[Optional[StrictStr]]] = Field(default=None, alias="criterionIds")
    ...
    characteristics: Optional[List[CharacteristicInput]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "characteristics": [CharacteristicInput.from_dict(_item) for _item in obj["characteristics"]] if obj.get("characteristics") is not None else None
        })
        return _obj

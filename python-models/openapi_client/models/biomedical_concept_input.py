...
class BiomedicalConceptInput(BaseModel):
    ...
    reference: StrictStr
    properties: Optional[List[BiomedicalConceptPropertyInput]] = None
    code: Optional[AliasCode]
    notes: Optional[List[CommentAnnotation]] = None
    instance_type: StrictStr = Field(alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "name", "label", "synonyms", "reference", "properties", "code", "notes", "instanceType"]

    @field_validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['BiomedicalConcept']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [BiomedicalConceptPropertyInput.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None,

...
class BiomedicalConceptPropertyOutput(BaseModel):
    ...
    datatype: StrictStr
    response_codes: Optional[List[ResponseCode]] = Field(default=None, alias="responseCodes")
    code: Optional[AliasCode]
    notes: Optional[List[CommentAnnotation]] = None
    instance_type: StrictStr = Field(alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "name", "label", "isRequired", "isEnabled", "datatype", "responseCodes", "code", "notes", "instanceType"]

    @field_validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['BiomedicalConceptProperty']):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.response_codes:
            for _item_response_codes in self.response_codes:
                if _item_response_codes:
                    _items.append(_item_response_codes.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "responseCodes": [ResponseCode.from_dict(_item) for _item in obj["responseCodes"]] if obj.get("responseCodes") is not None else None,
            "code": AliasCode.from_dict(obj["code"]) if obj.get("code") is not None else None,

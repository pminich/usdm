...
class BiospecimenRetention(BaseModel):
    ...
    is_retained: StrictBool = Field(alias="isRetained")
    includes_dna: Optional[StrictBool] = Field(default=None, alias="includesDNA")
    instance_type: StrictStr = Field(alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "name", "label", "description", "isRetained", "includesDNA", "instanceType"]

    @field_validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['BiospecimenRetention']):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.includes_dna is None and "includes_dna" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isRetained": obj.get("isRetained"),
            "includesDNA": obj.get("includesDNA"),

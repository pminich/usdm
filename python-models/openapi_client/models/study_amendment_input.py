...
class StudyAmendmentInput(BaseModel):
    ...
    impacts: Optional[List[StudyAmendmentImpactInput]] = None
    geographic_scopes: List[GeographicScopeInput] = Field(alias="geographicScopes")
    enrollments: Optional[List[SubjectEnrollmentInput]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "impacts": [StudyAmendmentImpactInput.from_dict(_item) for _item in obj["impacts"]] if obj.get("impacts") is not None else None,
            "geographicScopes": [GeographicScopeInput.from_dict(_item) for _item in obj["geographicScopes"]] if obj.get("geographicScopes") is not None else None,
            "enrollments": [SubjectEnrollmentInput.from_dict(_item) for _item in obj["enrollments"]] if obj.get("enrollments") is not None else None,

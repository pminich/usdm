...
class IngredientOutput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "role", "substance", "instanceType"]

    @field_validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Ingredient']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "substance": SubstanceOutput.from_dict(obj["substance"]) if obj.get("substance") is not None else None,

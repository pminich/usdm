...
class StrengthInput(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "denominator": QuantityInput.from_dict(obj["denominator"]) if obj.get("denominator") is not None else None,
            "numerator": Numerator.from_dict(obj["numerator"]) if obj.get("numerator") is not None else None,

...
class BiomedicalConceptCategoryInput(BaseModel):
    ...
    member_ids: Optional[List[Optional[StrictStr]]] = Field(default=None, alias="memberIds")
    code: Optional[AliasCode] = None
    notes: Optional[List[CommentAnnotation]] = None
    instance_type: StrictStr = Field(alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "name", "label", "description", "childIds", "memberIds", "code", "notes", "instanceType"]

    @field_validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['BiomedicalConceptCategory']):

...
class BiomedicalConceptOutput(BaseModel):
    ...
    reference: StrictStr
    properties: Optional[List[BiomedicalConceptPropertyOutput]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [BiomedicalConceptPropertyOutput.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None,

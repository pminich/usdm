...
class AdministrableProductInput(BaseModel):
    ...
    administrable_dose_form: AliasCode = Field(alias="administrableDoseForm")
    product_designation: Code = Field(alias="productDesignation")
    sourcing: Optional[Code] = None
    properties: Optional[List[AdministrableProductPropertyInput]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [AdministrableProductPropertyInput.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None,
            ...
            "ingredients": [IngredientInput.from_dict(_item) for _item in obj["ingredients"]] if obj.get("ingredients") is not None else None,

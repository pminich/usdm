...
class ConditionInput(BaseModel):
    ...
    context_ids: Optional[List[Optional[StrictStr]]] = Field(default=None, alias="contextIds")
    applies_to_ids: Optional[List[Optional[StrictStr]]] = Field(default=None, alias="appliesToIds")
    __properties: ClassVar[List[str]] = ["id", "name", "label", "description", "text", "dictionaryId", "notes", "instanceType", "contextIds", "appliesToIds"]

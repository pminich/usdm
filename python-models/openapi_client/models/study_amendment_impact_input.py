...
class StudyAmendmentImpactInput(BaseModel):
    """
    ...
    type: Code
    text: StrictStr
    is_substantial: StrictBool = Field(alias="isSubstantial")
    notes: Optional[List[CommentAnnotation]] = None
    instance_type: StrictStr = Field(alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "type", "text", "isSubstantial", "notes", "instanceType"]

    @field_validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['StudyAmendmentImpact']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text": obj.get("text"),
            "isSubstantial": obj.get("isSubstantial"),

...
class DocumentContentReference(BaseModel):
    ...
    applies_to_id: StrictStr = Field(alias="appliesToId")
    instance_type: StrictStr = Field(alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "sectionNumber", "sectionTitle", "appliesToId", "instanceType"]

    @field_validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['DocumentContentReference']):

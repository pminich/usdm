...
class ProcedureInput(BaseModel):
    ...
    procedure_type: StrictStr = Field(alias="procedureType")
    code: Code
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "label", "description", "procedureType", "code", "studyInterventionId", "notes", "instanceType"]

    @field_validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Procedure']):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.study_intervention_id is None and "study_intervention_id" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "procedureType": obj.get("procedureType"),
            "code": Code.from_dict(obj["code"]) if obj.get("code") is not None else None,
            "studyInterventionId": obj.get("studyInterventionId"),

...
class SubstanceInput(BaseModel):
    ...
    strengths: List[StrengthInput]
    reference_substance: Optional[SubstanceInput] = Field(default=None, alias="referenceSubstance")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "strengths": [StrengthInput.from_dict(_item) for _item in obj["strengths"]] if obj.get("strengths") is not None else None,
            "referenceSubstance": SubstanceInput.from_dict(obj["referenceSubstance"]) if obj.get("referenceSubstance") is not None else None,
            "instanceType": obj.get("instanceType")
        })
        return _obj

# TODO: Rewrite to not use raise_errors
SubstanceInput.model_rebuild(raise_errors=False)

...
class AbbreviationInput(BaseModel):
    """
    AbbreviationInput
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)]
    abbreviated_text: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="abbreviatedText")
    expanded_text: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="expandedText")
    notes: Optional[List[CommentAnnotation]] = None
    instance_type: StrictStr = Field(alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "abbreviatedText", "expandedText", "notes", "instanceType"]

    @field_validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Abbreviation']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "abbreviatedText": obj.get("abbreviatedText"),
            "expandedText": obj.get("expandedText"),

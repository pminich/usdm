...
class StudyElementInput(BaseModel):
    ...
    study_intervention_ids: Optional[List[Optional[StrictStr]]] = Field(default=None, alias="studyInterventionIds")
    notes: Optional[List[CommentAnnotation]] = None
    instance_type: StrictStr = Field(alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "name", "label", "description", "transitionStartRule", "transitionEndRule", "studyInterventionIds", "notes", "instanceType"]

    @field_validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['StudyElement']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "studyInterventionIds": obj.get("studyInterventionIds"),

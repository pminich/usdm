...
class StudyDesignPopulationOutput(BaseModel):
    ...
    cohorts: Optional[List[StudyCohortOutput]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cohorts": [StudyCohortOutput.from_dict(_item) for _item in obj["cohorts"]] if obj.get("cohorts") is not None else None
        })
        return _obj

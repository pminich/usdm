...
class AdministrableProductIdentifier(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "text", "scopeId", "instanceType"]

    @field_validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AdministrableProductIdentifier']):
            raise ValueError("must be one of enum values ('AdministrableProductIdentifier')")
        return value

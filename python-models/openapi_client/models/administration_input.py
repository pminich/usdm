...
class AdministrationInput(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "duration": AdministrationDurationInput.from_dict(obj["duration"]) if obj.get("duration") is not None else None,
            "dose": QuantityInput.from_dict(obj["dose"]) if obj.get("dose") is not None else None,

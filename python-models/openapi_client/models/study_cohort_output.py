...
class StudyCohortOutput(BaseModel):
    """
    StudyCohortOutput
    """ # noqa: E501
    ...
    characteristics: Optional[List[CharacteristicOutput]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "label", "description", "includesHealthySubjects", "plannedEnrollmentNumber", "plannedCompletionNumber", "plannedSex", "criterionIds", "plannedAge", "notes", "instanceType", "characteristics"]

    @field_validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['StudyCohort']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plannedEnrollmentNumber": RangeOutput.from_dict(obj["plannedEnrollmentNumber"]) if obj.get("plannedEnrollmentNumber") is not None else None,
            "plannedCompletionNumber": RangeOutput.from_dict(obj["plannedCompletionNumber"]) if obj.get("plannedCompletionNumber") is not None else None,
            ...
            "plannedAge": RangeOutput.from_dict(obj["plannedAge"]) if obj.get("plannedAge") is not None else None,
            ...
            "characteristics": [CharacteristicOutput.from_dict(_item) for _item in obj["characteristics"]] if obj.get("characteristics") is not None else None
        })
        return _obj

...
class AnalysisPopulationInput(BaseModel):
    ...
    text: StrictStr
    subset_of_ids: Optional[List[Optional[StrictStr]]] = Field(default=None, alias="subsetOfIds")
    notes: Optional[List[CommentAnnotation]] = None
    instance_type: StrictStr = Field(alias="instanceType")
    __properties: ClassVar[List[str]] = ["id", "name", "label", "description", "text", "subsetOfIds", "notes", "instanceType"]

    @field_validator('instance_type')
    def instance_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AnalysisPopulation']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text": obj.get("text"),
            "subsetOfIds": obj.get("subsetOfIds"),

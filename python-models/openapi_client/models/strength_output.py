...
class StrengthOutput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "label", "description", "denominator", "numerator", "instanceType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "denominator": QuantityOutput.from_dict(obj["denominator"]) if obj.get("denominator") is not None else None,
            "numerator": Numerator1.from_dict(obj["numerator"]) if obj.get("numerator") is not None else None,
